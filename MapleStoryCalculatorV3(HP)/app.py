...
class AppWindow(QtWidgets.QDialog):
    ...
    def loadUIConfig(me):
        ...
        myUI.viewEquipment_origin_STAR.textChanged.connect(me.calc_Equipment)
        ...
        myUI.viewEquipment_Set1_STAR.textChanged.connect(me.calc_Equipment)
        ...
        myUI.viewEquipment_Set2_STAR.textChanged.connect(me.calc_Equipment)
    ...
    def doSelectFile(me):
        try:
            ...
            for row in iter(data):
                ...
                if (item[0] == 'HP_AP_FIX'): myUI.viewAbility_HP_AP_FIX.setText(item[1])
                ...
                if (item[0] == 'STAR'): myUI.viewAbility_STAR.setText(item[1])
    ...
    def doSaveFile(me):
        try:
            ...
            array = [
                ...
                'HP_AP_FIX=' + str(myUI.viewAbility_HP_AP_FIX.text()) + '\n',
                ...
                'STAR=' + str(myUI.viewAbility_STAR.text()) + '\n',
    ...
    def doSubmit(me):
        try:
            ...
            data = {
                ...
                'STAR': myUI.textToInt(myUI.viewAbility_STAR.text()),
            }
            if myUI.viewAbility_HP_AP_FIX.text():
                data['HP_AP'] = myUI.textToInt(myUI.viewAbility_HP_AP_FIX.text())
            else:
                data['HP_AP'] = 545 + 90*data['LEVEL']
        ...
        try:
            ...
            def getData():
                new_data = {
                    ...
                    'HP_CLEAR': 0 - (myUI.textToFloat(myUI.viewEquipment_origin_HP.text()) / 2),
            ...
            Origin_Star = myCharactor.data['STAR']
            Origin_Star_HP = myCharactor.calcStarHP(Origin_Star)
            ...
            SET_INFO['HP_CLEAR'] += (myUI.textToFloat(myUI.viewEquipment_Set1_HP.text())/2)
            ...
            Set1_Star = Origin_Star - myUI.textToFloat(myUI.viewEquipment_origin_STAR.text()) + myUI.textToFloat(myUI.viewEquipment_Set1_STAR.text())
            Set1_Star_HP = myCharactor.calcStarHP(Set1_Star)
            SET_INFO['HP_CLEAR'] += Set1_Star_HP - Origin_Star_HP
            ...
            SET_INFO['HP_CLEAR'] += (myUI.textToFloat(myUI.viewEquipment_Set2_HP.text())/2)
            ...
            Set2_Star = Origin_Star - myUI.textToFloat(myUI.viewEquipment_origin_STAR.text()) + myUI.textToFloat(myUI.viewEquipment_Set2_STAR.text())
            Set2_Star_HP = myCharactor.calcStarHP(Set2_Star)
            SET_INFO['HP_CLEAR'] += Set2_Star_HP - Origin_Star_HP
