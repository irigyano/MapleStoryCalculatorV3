...
class Calculator_UI():
    ...
    def desingPage_Ability(me):
        ...
        me.viewAbility_LEVEL.textChanged.connect(me.updateHPAPValue)
        ...
        me.viewAbility_HP_AP = me.makeField(page, QtWidgets.QLabel(page), 15, 240, 200, 24)
        me.viewAbility_HP_AP.setText('試算AP血量 = 0')
        me.viewAbility_HP_AP_FIX = me.makeField(page, QtWidgets.QLineEdit(page), 230, 240, 125, 24, '修正', 55)

        me.viewAbility_STR_CLEAR = me.makeField(page, QtWidgets.QLineEdit(page), 15, 270, 200, 24, '吃% STR', 90)
        me.viewAbility_STR_P = me.makeField(page, QtWidgets.QLineEdit(page), 230, 270, 125, 24, 'STR%', 55, '％')
        me.viewAbility_STR_UNIQUE = me.makeField(page, QtWidgets.QLineEdit(page), 370, 270, 200, 24, '不吃% STR', 100)

        me.viewAbility_STAR = me.makeField(page, QtWidgets.QLineEdit(page), 15, 300, 200, 24, '裝備星力', 90)

        me.viewAbility_DEFENSE_P = me.makeField(page, QtWidgets.QLineEdit(page), 15, 370, 270, 24, '怪物防禦', 90, '％')

        return page
    
    def updateHPAPValue(me):
        if me.viewAbility_LEVEL.text():
            LEVEL = int(me.viewAbility_LEVEL.text())
        else:
            LEVEL = 0
        HP_AP = 545 + LEVEL*90
        me.viewAbility_HP_AP.setText('試算AP血量 = ' + str(HP_AP))
    ...
    def desingPage_Parameter(me):
        ...
        me.makeField(page, QtWidgets.QLineEdit(page), 260, 15, 100, 24, '', 0, '　HP', 50).setEnabled(False)
        me.makeField(page, QtWidgets.QLineEdit(page), 365, 15, 100, 24, '', 0, '％HP', 50).setEnabled(False)
        me.makeField(page, QtWidgets.QLineEdit(page), 470, 15, 100, 24, '', 0, '不吃％HP', 50).setEnabled(False)
        ...
        me.makeField(page, QtWidgets.QLineEdit(page), 260, 45, 100, 24, '', 0, '　力量', 50).setEnabled(False)
        me.makeField(page, QtWidgets.QLineEdit(page), 365, 45, 100, 24, '', 0, '％力量', 50).setEnabled(False)
        me.makeField(page, QtWidgets.QLineEdit(page), 470, 45, 100, 24, '', 0, '不吃％力', 50).setEnabled(False)
        ...
        me.viewParameter_EQUIVALENT_HP_P       = me.makeField(page, QtWidgets.QLabel(page), 5 + 365, 15, 100, 24)
        me.viewParameter_EQUIVALENT_HP_UNIQUE  = me.makeField(page, QtWidgets.QLabel(page), 5 + 470, 15, 100, 24)
        ...
        me.viewParameter_EQUIVALENT_STR_CLEAR   = me.makeField(page, QtWidgets.QLabel(page), 5 + 260, 45, 100, 24)
        me.viewParameter_EQUIVALENT_STR_P       = me.makeField(page, QtWidgets.QLabel(page), 5 + 365, 45, 100, 24)
        me.viewParameter_EQUIVALENT_STR_UNIQUE  = me.makeField(page, QtWidgets.QLabel(page), 5 + 470, 45, 100, 24)
        ...
        me.viewParameter_EQUIVALENT_STAR        = me.makeField(page, QtWidgets.QLabel(page), 5 + 260, 75, 100, 24)
        ...
        # 單項增幅
        me.viewParameter_IMPROVE_VALUE_HP_CLEAR    = me.makeField(page, QtWidgets.QLineEdit(page), 15, 140, 115, 24, 'HP　 增加', 65)
        me.viewParameter_IMPROVE_VALUE_HP_P        = me.makeField(page, QtWidgets.QLineEdit(page), 15, 170, 115, 24, 'HP％　 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_HP_UNIQUE   = me.makeField(page, QtWidgets.QLineEdit(page), 15, 200, 115, 24, '不吃％HP 增加', 65)
        me.viewParameter_IMPROVE_VALUE_STR_CLEAR    = me.makeField(page, QtWidgets.QLineEdit(page), 240, 140, 115, 24, '力量　 增加', 65)
        me.viewParameter_IMPROVE_VALUE_STR_P        = me.makeField(page, QtWidgets.QLineEdit(page), 240, 170, 115, 24, '力量％ 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_STR_UNIQUE   = me.makeField(page, QtWidgets.QLineEdit(page), 240, 200, 115, 24, '不吃％力 增加', 65)
        me.viewParameter_IMPROVE_VALUE_ALL_P        = me.makeField(page, QtWidgets.QLineEdit(page), 15, 230, 115, 24, '全屬％ 增加', 65, '%')

        me.viewParameter_IMPROVE_VALUE_DMG_P    = me.makeField(page, QtWidgets.QLineEdit(page), 15, 260, 115, 24, '總傷％ 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_BOSS_P   = me.makeField(page, QtWidgets.QLineEdit(page), 15, 290, 115, 24, 'Ｂ傷％ 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_STRIKE_P = me.makeField(page, QtWidgets.QLineEdit(page), 15, 320, 115, 24, '爆傷％ 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_IGNORE_P = me.makeField(page, QtWidgets.QLineEdit(page), 15, 350, 115, 24, '無視％ 增加', 65, '%')
        me.viewParameter_IMPROVE_VALUE_ATT      = me.makeField(page, QtWidgets.QLineEdit(page), 240, 230, 115, 24, '攻擊　 增加', 65)
        me.viewParameter_IMPROVE_VALUE_ATT_P    = me.makeField(page, QtWidgets.QLineEdit(page), 240, 260, 115, 24, '攻擊％ 增加', 65, '%')

        me.viewParameter_IMPROVE_HP_CLEAR  = me.makeField(page, QtWidgets.QLabel(page), 140, 140, 120, 24)
        me.viewParameter_IMPROVE_HP_P      = me.makeField(page, QtWidgets.QLabel(page), 140, 170, 120, 24)
        me.viewParameter_IMPROVE_HP_UNIQUE = me.makeField(page, QtWidgets.QLabel(page), 140, 200, 120, 24)
        me.viewParameter_IMPROVE_STR_CLEAR  = me.makeField(page, QtWidgets.QLabel(page), 360, 140, 120, 24)
        me.viewParameter_IMPROVE_STR_P      = me.makeField(page, QtWidgets.QLabel(page), 360, 170, 120, 24)
        me.viewParameter_IMPROVE_STR_UNIQUE = me.makeField(page, QtWidgets.QLabel(page), 360, 200, 120, 24)
        me.viewParameter_IMPROVE_ALL_P      = me.makeField(page, QtWidgets.QLabel(page), 140, 230, 120, 24)

        me.viewParameter_IMPROVE_ATT      = me.makeField(page, QtWidgets.QLabel(page), 360, 230, 120, 24)
        me.viewParameter_IMPROVE_ATT_P    = me.makeField(page, QtWidgets.QLabel(page), 360, 260, 120, 24)
        me.viewParameter_IMPROVE_DMG_P    = me.makeField(page, QtWidgets.QLabel(page), 140, 260, 120, 24)
        me.viewParameter_IMPROVE_BOSS_P   = me.makeField(page, QtWidgets.QLabel(page), 140, 290, 120, 24)
        me.viewParameter_IMPROVE_STRIKE_P = me.makeField(page, QtWidgets.QLabel(page), 140, 320, 120, 24)
        me.viewParameter_IMPROVE_IGNORE_P = me.makeField(page, QtWidgets.QLabel(page), 140, 350, 120, 24)
        ...
        me.viewParameter_ESTIMATE_HP   = me.makeField(page, QtWidgets.QLabel(page), 462, 140 + 18 * 0, 108, 18, 'HP' , 40, '' , 19)
        me.viewParameter_ESTIMATE_HP_P = me.makeField(page, QtWidgets.QLabel(page), 462, 140 + 18 * 1, 108, 18, 'HP%', 40, '%', 19)

        me.viewParameter_ESTIMATE_STR   = me.makeField(page, QtWidgets.QLabel(page), 462, 140 + 18 * 2, 108, 18, 'STR' , 40, '' , 19)
        me.viewParameter_ESTIMATE_STR_P = me.makeField(page, QtWidgets.QLabel(page), 462, 140 + 18 * 3, 108, 18, 'STR%', 40, '%', 19)
    ...
    def desingPage_Equipment(me):
        ...
        me.makeField(page, QtWidgets.QLineEdit(page),11, 38, 138, 15+26*11).setEnabled(False)
        me.viewEquipment_origin_STAR      = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  1, 130, 24, '星力' , 55, '')
        me.viewEquipment_origin_STR       = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  2, 130, 24, 'STR' , 55, '')
        me.viewEquipment_origin_STR_P     = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  3, 130, 24, 'STR%', 55, '％')
        me.viewEquipment_origin_HP        = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  4, 130, 24, 'HP' , 55, '')
        me.viewEquipment_origin_HP_P      = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  5, 130, 24, 'HP%', 55, '％')
        me.viewEquipment_origin_ALL_P     = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  6, 130, 24, '全屬%', 55, '％')
        me.viewEquipment_origin_ATTACK    = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  7, 130, 24, '攻擊' , 55, '')
        me.viewEquipment_origin_ATTACK_P  = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  8, 130, 24, '攻擊%', 55, '％')
        me.viewEquipment_origin_DMG_P     = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 *  9, 130, 24, '傷害%', 55, '％')
        me.viewEquipment_origin_STRIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 * 10, 130, 24, '爆傷%', 55, '％')
        me.viewEquipment_origin_IGNORE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 15, 15 + 26 * 11, 130, 24, '無視%', 55, '％')
        ...
        me.makeField(page, QtWidgets.QLineEdit(page),188, 38, 138, 15+26*11).setEnabled(False)
        me.viewEquipment_Set1_STAR      = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  1, 130, 24, '星力' , 55, '')
        me.viewEquipment_Set1_STR       = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  2, 130, 24, 'STR' , 55, '')
        me.viewEquipment_Set1_STR_P     = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  3, 130, 24, 'STR%', 55, '％')
        me.viewEquipment_Set1_HP        = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  4, 130, 24, 'HP' , 55, '')
        me.viewEquipment_Set1_HP_P      = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  5, 130, 24, 'HP%', 55, '％')
        me.viewEquipment_Set1_ALL_P     = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  6, 130, 24, '全屬%', 55, '％')
        me.viewEquipment_Set1_ATTACK    = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  7, 130, 24, '攻擊' , 55, '')
        me.viewEquipment_Set1_ATTACK_P  = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  8, 130, 24, '攻擊%', 55, '％')
        me.viewEquipment_Set1_DMG_P     = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 *  9, 130, 24, '傷害%', 55, '％')
        me.viewEquipment_Set1_STRIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 * 10, 130, 24, '爆傷%', 55, '％')
        me.viewEquipment_Set1_IGNORE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 192, 15 + 26 * 11, 130, 24, '無視%', 55, '％')
        me.viewEquipment_Set1_IMPROVE   = me.makeField(page, QtWidgets.QLabel(page), 192, 15 + 26 * 13, 130, 24)
        me.viewEquipment_Set1_IMPROVE.setText('增幅 0.0%')

        me.makeField(page, QtWidgets.QLabel(page),370, 15, 130, 24).setText('更換裝備2')
        me.makeField(page, QtWidgets.QLineEdit(page),366, 38, 138, 15+26*11).setEnabled(False)
        me.viewEquipment_Set2_STAR      = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  1, 130, 24, '星力' , 55, '')
        me.viewEquipment_Set2_STR       = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  2, 130, 24, 'STR' , 55, '')
        me.viewEquipment_Set2_STR_P     = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  3, 130, 24, 'STR%', 55, '％')
        me.viewEquipment_Set2_HP        = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  4, 130, 24, 'HP' , 55, '')
        me.viewEquipment_Set2_HP_P      = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  5, 130, 24, 'HP%', 55, '％')
        me.viewEquipment_Set2_ALL_P     = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  6, 130, 24, '全屬%', 55, '％')
        me.viewEquipment_Set2_ATTACK    = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  7, 130, 24, '攻擊' , 55, '')
        me.viewEquipment_Set2_ATTACK_P  = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  8, 130, 24, '攻擊%', 55, '％')
        me.viewEquipment_Set2_DMG_P     = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 *  9, 130, 24, '傷害%', 55, '％')
        me.viewEquipment_Set2_STRIKE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 * 10, 130, 24, '爆傷%', 55, '％')
        me.viewEquipment_Set2_IGNORE_P  = me.makeField(page, QtWidgets.QLineEdit(page), 370, 15 + 26 * 11, 130, 24, '無視%', 55, '％')
        me.viewEquipment_Set2_IMPROVE   = me.makeField(page, QtWidgets.QLabel(page), 370, 15 + 26 * 13, 130, 24)
